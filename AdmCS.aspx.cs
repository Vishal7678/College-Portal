...
public partial class AdmCS : System.Web.UI.Page
{
    ...
    public void getidno()
    {
        ...
        SqlCommand cmd = new SqlCommand("select Count(ApplicationNo) from Admission13");
        ...
        else
        {
            ...
            String myquery1 = "select max(ApplicationNo) from Admission13";
