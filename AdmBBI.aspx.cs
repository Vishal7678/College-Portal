...
public partial class AdmBBI : System.Web.UI.Page
{
    ...
    public void getidno()
    {
        ...
        SqlCommand cmd = new SqlCommand("select Count(ApplicationNo) from Admission14");
        ...
        else
        {
            ...
            String myquery1 = "select max(ApplicationNo) from Admission14";
